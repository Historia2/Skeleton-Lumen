...
import DetailTableSegment from "./components/segmentation/detail-table-segment.component";
import highchartsData from "highcharts/modules/data";
import highchartsExportData from "highcharts/modules/export-data";
import HighchartsOfflineExporting from 'highcharts/modules/offline-exporting';
import SegmentPoint from "./components/segmentation/segment-point.component";
...
class InsightSegment extends Component {
    constructor() {
        super();
        this.state = {
            hcOptions: {
        ...
        return (
            <div className={"row wr content "}>
                <div className={"rate-container row ml-0"}>
                    <div className={"col-12 rate-content px-0"}>
                        <SegmentPoint openCurtain={openCurtain} />
                    </div>
                    <div className={"col-12 rate-content px-0"}>
                        <HighchartsReact
